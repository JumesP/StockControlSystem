...
public class Fruits extends Chilled{
    ...
    public Fruits(String Product_Name, Number Product_ID, Number Product_Price, Number Product_Quantity, String Last_Stocked, String Useby_Date, Number Storage_Temperature, String Department) {
