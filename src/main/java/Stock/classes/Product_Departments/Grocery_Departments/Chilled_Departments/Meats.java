...
public class Meats extends Chilled {
    ...
    private static String Description = "Dont eat this raw! Very tasty when cooked!";

    public Meats(String Product_Name, int Product_ID, Integer Product_Restock_Price, Integer Product_Sale_Price, int Product_Quantity, int Last_Stocked, int Department_ID){
